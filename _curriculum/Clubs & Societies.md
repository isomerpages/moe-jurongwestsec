...
<thead>
  <tr>
    <th class="tg-amwm"><br><img height="407" width="406" alt="B.jpg" src="/images/B1.jpg"><span style="font-weight:400">#Student Artist: Goh Min Xuan Ebelle (4E4’20)</span></th>
    <th class="tg-amwm"><img height="485" width="345" alt="C.jpg" src="/images/C1.jpg"><span style="font-weight:400">#Student Artist: Iklil Nur Atiqah Binte Rus Lee (4E4’20)</span></th>
  </tr>
</thead>
<tbody>
  <tr>
    <td class="tg-0lax"><img width="552" alt="D.jpg" src="/images/d1.jpg"># <br>Student Artist: Amelia Fu Meile (1T1’20)</td>
    <td class="tg-0lax"><img height="725" width="539" alt="E.jpg" src="/images/EEE.jpg">#Student Artist: Cheryl Ang Suhartono</td>
  </tr>
</tbody>
</table>

<h4 align="center" style="color:purple">Live-On Competition by National Organ Transplant Unit</h4>

  

<table class="ive_eobj_center ives_tab_kosong" style="margin: auto; outline: 0px; padding: 0px; border-collapse: collapse; clear: both; border: 1px solid transparent; table-layout: fixed; width: 1136.97px;"><tbody style="margin: 0px; outline: 0px; padding: 0px;"><tr style="margin: 0px; outline: 0px; padding: 0px;"><td style="margin: 0px; outline: 0px; padding: 0px 15px 15px 0px; vertical-align: top; width: 60px;"><img src="/images/F1.jpg" alt="F.jpg" class="ive_eobj_center" style="margin: auto; outline: none; padding: 0px; border: none; clear: both; display: block; width: 385px; height: 622px;"><br style="margin: 0px; outline: 0px; padding: 0px;">MERIT AWARD<br style="margin: 0px; outline: 0px; padding: 0px;">Student Artist: Naomi Balqis Binte Norizal (2N1’20)<br style="margin: 0px; outline: 0px; padding: 0px;"></td><td style="margin: 0px; outline: 0px; padding: 0px 15px 15px 0px; vertical-align: top; width: 60px;"><br style="margin: 0px; outline: 0px; padding: 0px;"><br style="margin: 0px; outline: 0px; padding: 0px;"><img src="/images/GGG.jpg" width="100%" alt="G.jpg" class="ive_eobj_center" style="margin: auto; outline: none; padding: 0px; border: none; clear: both; display: block; width: 454px; height: 464px;"><br style="margin: 0px; outline: 0px; padding: 0px;">Student Artist: Clarisse Chia Wen Hui (1E4’20)<br style="margin: 0px; outline: 0px; padding: 0px;"></td></tr><tr style="margin: 0px; outline: 0px; padding: 0px;"><td style="margin: 0px; outline: 0px; padding: 0px 15px 15px 0px; vertical-align: top; width: 60px;"><img src="/images/H1.jpg" alt="H.jpg" class="ive_eobj_center" style="margin: auto; outline: none; padding: 0px; border: none; clear: both; display: block; width: 439px; height: 439px;"><br style="margin: 0px; outline: 0px; padding: 0px;">Student Artist: Jean Yeo Zi Jun (2E1’20)</td><td style="margin: 0px; outline: 0px; padding: 0px 15px 15px 0px; vertical-align: top; width: 60px;"><img src="/images/I1.jpg" width="100%" alt="I.jpg" class="ive_eobj_center" style="margin: auto; outline: none; padding: 0px; border: none; clear: both; display: block; width: 494px; height: 350px;"><br style="margin: 0px; outline: 0px; padding: 0px;">Student Artist: Lee Hui Min (2E2’20)</td></tr><tr style="margin: 0px; outline: 0px; padding: 0px;"><td style="margin: 0px; outline: 0px; padding: 0px 15px 15px 0px; vertical-align: top;">&nbsp;<img src="/images/J1.jpg" alt="J.jpg" class="ive_eobj_center" style="margin: auto; outline: none; padding: 0px; border: none; clear: both; display: block; width: 419px; height: 561px;"><br style="margin: 0px; outline: 0px; padding: 0px;">Student Artist: Nur Kamelia Binte Zainudin (3E4’20)<br style="margin: 0px; outline: 0px; padding: 0px;"></td><td style="margin: 0px; outline: 0px; padding: 0px 15px 15px 0px; vertical-align: top;"><img src="/images/K1.jpg" width="100%" alt="K.jpg" class="ive_eobj_center" style="margin: auto; outline: none; padding: 0px; border: none; clear: both; display: block; width: 478px; height: 443px;"><br style="margin: 0px; outline: 0px; padding: 0px;">Student Artist: Chow Zhenyu (1N1’20)&nbsp;</td></tr></tbody></table>

<h4 align="center" style="color:purple">SYFstrongerTogether Project</h4>
